            ...
            return (
              <motion.article
                ...
                <motion.div
                  ...
                  {/* Mini Photo / Logo Area */}
                  {card.logo && (
                    <motion.div
                      className="absolute bottom-3 right-3 w-10 h-10 bg-white rounded-lg p-1.5 shadow-md flex items-center justify-center overflow-hidden"
                ...
                {/* Content */}
                <motion.div layoutId={`card-content-${card.id}`} className="p-6 bg-white">
                  <motion.h3
